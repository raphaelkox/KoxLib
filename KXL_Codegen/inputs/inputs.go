...
func UpdateInputGroups() {
	...
	filePath := "../KXL/InputSystem/InputManager.cs"
...
func updateInputGroup(inputGroup *InputGroup) {
	...
	filePath := fmt.Sprintf("../KXL/InputSystem/%sInputGroup.cs", name)
	os.Truncate(filePath, 0)
	file, err := os.OpenFile(filePath, os.O_CREATE|os.O_WRONLY, 0644)
	if err != nil {
...
func updateInputConsumer(inputGroup *InputGroup) {
	name := inputGroup.Name
	filePath := fmt.Sprintf("../KXL/InputSystem/%sInputConsumer.cs", name)
	os.Truncate(filePath, 0)
	file, err := os.OpenFile(filePath, os.O_CREATE|os.O_WRONLY, 0644)
	if err != nil {
